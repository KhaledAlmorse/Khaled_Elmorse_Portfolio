        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          <div className="lg:col-span-4 reveal-left space-y-6">
            ...
            <p className="text-lg leading-relaxed text-on-surface-variant dark:text-slate-300 max-w-md">
              Hands-on backend experience built through intensive training and
              real-world style projects, with a focus on secure APIs, scalable
              architecture, and performance-first implementation.
            </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-on-surface-variant dark:text-slate-300 leading-relaxed max-w-2xl">
                      Built backend systems in training and portfolio projects
                      that mirror production workflows, including modular API
                      design, authentication, authorization, middleware
                      handling, and database optimization.
                    </p>
                  </div>
                </div>

                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-surface-container dark:bg-slate-800 text-on-surface-variant dark:text-slate-300 text-xs font-bold tracking-[0.25em] uppercase self-start">
                  2024
                </div>
              </div>
                ...
                <div className="rounded-2xl bg-surface dark:bg-slate-950/60 border border-outline-variant/15 dark:border-slate-800 p-6">
                  ...
                  <ul className="space-y-3 text-on-surface-variant dark:text-slate-300">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Designed RESTful APIs with multiple endpoints for
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Implemented authentication, authorization, and
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Optimized query performance and improved backend
